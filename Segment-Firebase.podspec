Pod::Spec.new do |s|
  ...
  s.source           = { :git => "https://github.com/fampaySiddharth/analytics-ios-integration-firebase.git", :tag => s.version.to_s }
  ...
  s.dependency 'Firebase/Crashlytics','~> 8.7'
  s.dependency 'Firebase/DynamicLinks','~> 8.7'
  s.dependency 'Firebase/Messaging','~> 8.7'
  s.dependency 'Firebase/RemoteConfig','~> 8.7'
  s.dependency 'FirebaseABTesting','~> 8.7'
